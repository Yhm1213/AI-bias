...
export const WblGenderDiscourseSlide: React.FC<WblGenderDiscourseSlideProps> = ({ language, toggleLanguage }) => {
    ...
    const lang = language;
    const wblInsightTitle = (t('wblDiscourse', { returnObjects: true }) as any)[0]?.title || '';
    const wblInsightSections = (t('wblDiscourse', { returnObjects: true }) as Array<{ title: string; paragraphs: string[] }>) || [];
        ...
        <div className="flex flex-col h-screen w-full bg-transparent relative overflow-hidden transition-colors duration-500">
            ...
            <main className="flex-1 w-full h-full flex relative z-0">
                ...
                <div className="w-1/3 h-full flex flex-col justify-center pr-8 lg:pr-16 z-10">
                    <div id="wbl-scroll-box" className="h-[70%] max-h-[600px] overflow-y-scroll pr-4">
            ...
            <style>{`
                #wbl-scroll-box::-webkit-scrollbar {
                    -webkit-appearance: none !important;
                    display: block !important;
                    width: 6px !important;
                }
                #wbl-scroll-box::-webkit-scrollbar-track {
                    background: rgba(255, 255, 255, 0.06) !important;
                    border-radius: 10px !important;
                }
                #wbl-scroll-box::-webkit-scrollbar-thumb {
                    background-color: rgba(255, 255, 255, 0.35) !important;
                    border-radius: 10px !important;
                }
                #wbl-scroll-box:hover::-webkit-scrollbar-thumb {
