  ...
  return (
    <div className="fixed inset-0 bg-[#0a0a0a] z-[999] flex flex-col items-center justify-center p-6 overflow-hidden">
      <div className="max-w-3xl w-full flex flex-col items-center">
        <div className="font-quan text-xl md:text-3xl text-green-500 leading-relaxed mb-12 min-h-[5rem] text-center w-full">
          {displayText.split('\n').map((line, i) => (
        ...
        {isFinished && (
          <div className="animate-fade-in opacity-0 flex justify-center mt-4">
            <button
              onClick={onEnter}
              className="group relative px-12 py-3 bg-transparent border border-green-500 text-green-500 font-quan text-lg uppercase tracking-widest hover:bg-green-500/10 transition-all duration-300 overflow-hidden"
            >
