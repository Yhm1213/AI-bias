...
const DiscoverySlides: React.FC<DiscoverySlidesProps> = ({ onBack, onGoToData, language, toggleLanguage, highlightId, pendingScrollAction, onClearHighlight }) => {
  ...
  const GENDER_BIAS_DATA_CN = [
    {
      titleLeft: <>
        <span className="mx-1"><Keyword id="温柔" color="#F68CB2">温柔（Gentle）</Keyword>与<Keyword id="装饰" color="#F68CB2">装饰（Decorative）</Keyword></span>
        <span>的她，对比</span>
        <span className="mx-1"><Keyword id="高大" color="#2ABB3A">高大（Tall）</Keyword>与<Keyword id="力量" color="#2ABB3A">力量（Power）</Keyword></span>
        <span>的他</span>
      </>,
      content: (
        <>
          ...
          <p>
            在气质词频上，女性被牢牢锁定在
            <Keyword id="温柔" color="#F68CB2">温柔（Gentle）</Keyword>（33次）<Keyword id="优雅" color="#F68CB2">优雅（Elegant）</Keyword>（47次）
            等柔性特质中；而男性则由
            <Keyword id="坚韧" color="#2ABB3A">坚韧（Resilient）</Keyword>（185次）<Keyword id="勇敢" color="#2ABB3A">勇敢（Brave）</Keyword>（87次）<Keyword id="强" color="#2ABB3A">强（Strong）</Keyword>（137次）
            定义。这种对比在身体刻画上近乎极端：女性的描写往往指向视觉细节与服饰，如
            <Keyword id="头巾" color="#F68CB2">头巾（Headscarf）</Keyword>（87次）<Keyword id="长袍" color="#F68CB2">长袍（Robe）</Keyword>（81次）<Keyword id="时尚" color="#F68CB2">时尚（Fashion）</Keyword>（63次）
            ；而男性则被简化为纯粹的生理力量，如
            <Keyword id="高大" color="#2ABB3A">高大（Tall）</Keyword>（26次）
            与
            <Keyword id="强壮" color="#2ABB3A">强壮（Strong）</Keyword>（67次）
            。
          </p>
          <p>
    ...
    {
      titleLeft: <>
        <span className="mx-1"><Keyword id="照顾" color="#F68CB2">照顾（Care）</Keyword>家庭</span>
        <span>的她，对比</span>
        <span className="mx-1"><Keyword id="热爱" color="#2ABB3A">热爱（Love）</Keyword>世界</span>
        <span>的他</span>
      </>,
      content: (
        <>
          ...
          <p>
            在统计中，“家庭”是双方共同的高频词，但语境完全不同。女性的关键词是<Keyword id="照顾" color="#F68CB2">照顾（Care）</Keyword>（56次）、<Keyword id="核心" color="#F68CB2">核心（Core）</Keyword>（44次）、<Keyword id="和谐" color="#F68CB2">和谐（Harmony）</Keyword>（62次）。她们是家庭的润滑剂，负责具体的、重复的、维系性的事务。
          </p>
          <p>
            相比之下，男性的行为动词充满了<strong>外部探索性</strong>：他们<Keyword id="热爱" color="#2ABB3A">热爱（Love）</Keyword>（147次）、<Keyword id="喜欢" color="#2ABB3A">喜欢（Like）</Keyword>（297次）的对象是<Keyword id="足球" color="#2ABB3A">足球（Football）</Keyword>（100次）、<Keyword id="体育" color="#2ABB3A">体育（Sports）</Keyword>（48次）或<Keyword id="户外活动" color="#2ABB3A">户外活动（Outdoor activities）</Keyword>（118次）。
          </p>
          <p>
            同样是谈论“责任”，女性的<Keyword id="责任感" color="#F68CB2">责任感（Sense of responsibility）</Keyword>（85次）往往与家务琐事捆绑，是具体的<strong>无偿劳动</strong>；而男性的<Keyword id="责任感" color="#2ABB3A">责任感（Sense of responsibility）</Keyword>（218次）频次是女性的 2.5 倍，通常指向一种宏大的抽象品质。这意味着在模型的逻辑里，男性的责任是一种“社会光环”，而女性的责任则是一种“生存定式”。
          </p>
        </>
      )
    },
    {
      titleLeft: <>
        <span className="mx-1"><Keyword id="遵守" color="#F68CB2">遵守（Comply）</Keyword>规范</span>
        <span>的她，对比</span>
        <span className="mx-1"><Keyword id="开拓" color="#2ABB3A">开拓（Pioneering）</Keyword>疆域</span>
        <span>的他</span>
      </>,
      content: (
        <>
          ...
          <p>
            在女性的文本中，高频词包括
            <Keyword id="遵守" color="#F68CB2">遵守（Comply）</Keyword>、
            <Keyword id="扮演" color="#F68CB2">扮演（Playing a role）</Keyword>（307次）、
            <Keyword id="传统" color="#F68CB2">传统（Traditional）</Keyword>（785次）
            ，强调她们在既定社会框架内的<strong>适应与服从</strong>。而男性的高频词则更多涉及
            <Keyword id="职业" color="#2ABB3A">职业（Profession）</Keyword>（25次）、
            <Keyword id="商业" color="#2ABB3A">商业（Business）</Keyword>（30次）
            以及
            <Keyword id="社会" color="#2ABB3A">社会（Social）</Keyword>（109次）
            地位。
          </p>
          <p>
            即便在同样追求
            <Keyword id="平等" color="#F68CB2">平等（Equality）</Keyword>（48次 vs 43次）
            的语境下，女性更多是在争取
            <Keyword id="教育" color="#F68CB2">教育（Education）</Keyword>（306次）
            和
            <Keyword id="独立" color="#F68CB2">独立（Independence）</Keyword>（269次）
            的权利，而男性则早已在
            <Keyword id="经济" color="#2ABB3A">经济（Economy）</Keyword>（41次）
            与
            <Keyword id="传承" color="#2ABB3A">文化传承（Cultural inheritance）</Keyword>（225次）
  ...
  const GENDER_BIAS_DATA_EN = [
    {
      titleLeft: <>
        <span className="mx-1"><Keyword id="温柔" color="#F68CB2">温柔（Gentle）</Keyword> & <Keyword id="装饰" color="#F68CB2">装饰（Decorative）</Keyword></span>
        <span>Her vs.</span>
        <span className="mx-1"><Keyword id="高大" color="#2ABB3A">高大（Tall）</Keyword> & <Keyword id="力量" color="#2ABB3A">力量（Power）</Keyword></span>
        <span>Him</span>
      </>,
      content: (
        <>
          ...
          <p>
            ...
            <Keyword id="温柔" color="#F68CB2">温柔（Gentle）</Keyword>（33 times） and <Keyword id="优雅" color="#F68CB2">优雅（Elegant）</Keyword>（47 times）
            , while men are defined by
            <Keyword id="坚韧" color="#2ABB3A">坚韧（Resilient）</Keyword>（185 times）, <Keyword id="勇敢" color="#2ABB3A">勇敢（Brave）</Keyword>（87 times）, and <Keyword id="强" color="#2ABB3A">强（Strong）</Keyword>（137 times）
            ...
            <Keyword id="头巾" color="#F68CB2">头巾（Headscarf）</Keyword>（87 times）, <Keyword id="长袍" color="#F68CB2">长袍（Robe）</Keyword>（81 times）, and <Keyword id="时尚" color="#F68CB2">时尚（Fashion）</Keyword>（63 times）
            ; whereas men are simplified into pure physiological power, such as
            <Keyword id="高大" color="#2ABB3A">高大（Tall）</Keyword>（26 times）
            and
            <Keyword id="强壮" color="#2ABB3A">强壮（Strong）</Keyword>（67 times）
            .
          </p>
          <p>
    ...
    {
      titleLeft: <>
        <span className="mx-1"><Keyword id="照顾" color="#F68CB2">照顾（Care）</Keyword></span>
        <span>Family Woman vs.</span>
        <span className="mx-1"><Keyword id="热爱" color="#2ABB3A">热爱（Love）</Keyword></span>
      ...
      content: (
        <>
          ...
          <p>
            In our statistics, "family" is a high-frequency word for both sides, but the context is entirely different. For women, the keywords are <strong><Keyword id="照顾" color="#F68CB2">照顾（Care）</Keyword>（56 times）, <Keyword id="核心" color="#F68CB2">核心（Core）</Keyword>（44 times）, and <Keyword id="和谐" color="#F68CB2">和谐（Harmony）</Keyword>（62 times）</strong>. They are the lubricants of the family, responsible for specific, repetitive, and maintenance-oriented tasks.
          </p>
          <p>
            In contrast, men’s behavioral verbs are full of <strong>external exploration</strong>: the objects they <Keyword id="热爱" color="#2ABB3A">热爱（Love）</Keyword>（147 times） or <Keyword id="喜欢" color="#2ABB3A">喜欢（Like）</Keyword>（297 times） are <Keyword id="足球" color="#2ABB3A">足球（Football）</Keyword>（100 times）, <Keyword id="体育" color="#2ABB3A">体育（Sports）</Keyword>（48 times）, or <Keyword id="户外活动" color="#2ABB3A">户外活动（Outdoor activities）</Keyword>（118 times）.
          </p>
          <p>
            When discussing "responsibility," a woman’s <Keyword id="责任感" color="#F68CB2">责任感（Sense of responsibility）</Keyword>（85 times） is often tied to household chores—specific, <strong>unpaid labor</strong>. However, the frequency of a man’s <Keyword id="责任感" color="#2ABB3A">责任感（Sense of responsibility）</Keyword>（218 times） is 2.5 times higher and usually points to a grand, abstract quality. This implies that in the model's logic, male responsibility is a "social halo," while female responsibility is a "survival routine."
          </p>
        </>
      )
    },
    {
      titleLeft: <>
        <span className="mx-1"><Keyword id="遵守" color="#F68CB2">遵守（Comply）</Keyword></span>
        <span>Her vs.</span>
        <span className="mx-1"><Keyword id="开拓" color="#2ABB3A">开拓（Pioneering）</Keyword></span>
        <span>Him</span>
      </>,
      content: (
        <>
          ...
          <p>
            ...
            <Keyword id="遵守" color="#F68CB2">遵守（Comply）</Keyword>,
            <Keyword id="扮演" color="#F68CB2">扮演（Playing a role）</Keyword>（307 times）,
            and
            <Keyword id="传统" color="#F68CB2">传统（Traditional）</Keyword>（785 times）
            ...
            <Keyword id="职业" color="#2ABB3A">职业（Profession）</Keyword>（25 times）,
            <Keyword id="商业" color="#2ABB3A">商业（Business）</Keyword>（30 times）,
            and
            <Keyword id="社会" color="#2ABB3A">社会（Social）</Keyword>（109 times）
            status.
          </p>
          <p>
            Even in the shared context of pursuing
            <Keyword id="平等" color="#F68CB2">平等（Equality）</Keyword>（48 vs. 43 times）
            , women are more often striving for the right to
            <Keyword id="教育" color="#F68CB2">教育（Education）</Keyword>（306 times）
            and
            <Keyword id="独立" color="#F68CB2">独立（Independence）</Keyword>（269 times）
            , while men are already dominant in
            <Keyword id="经济" color="#2ABB3A">经济（Economy）</Keyword>（41 times）
            and
            <Keyword id="传承" color="#2ABB3A">文化传承（Cultural inheritance）</Keyword>（225 times）
      ...
      content: (
        <>
          ...
          <p>
            ...
            <Keyword id="grace" color="#F68CB2">优雅（Grace）</Keyword>（Grace，478次）
            与
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            数据显示，女性与
            <Keyword id="community" color="#F68CB2">社区（Community）</Keyword>（Community，1474次）、
            <Keyword id="balance" color="#F68CB2">平衡（Balance）</Keyword>（Balance，676次）、
            <Keyword id="education" color="#F68CB2">教育（Education）</Keyword>（Education，837次）
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            在女性的词簇中，出现了大量
            <Keyword id="equality" color="#F68CB2">平等（Equality）</Keyword>（Equality，495次）、
            <Keyword id="empowerment" color="#F68CB2">赋权（Empowerment）</Keyword>（Empowerment，321次）
            和
            <Keyword id="advocate" color="#F68CB2">倡议（Advocate）</Keyword>（Advocate，319次）
  ...
  const EN_GENDER_BIAS_DATA_EN = [
    {
      titleLeft: <>
        <span className="mx-1">Internalization of <Keyword id="grace" color="#F68CB2">Grace (优雅)</Keyword> vs.</span>
        <span className="mx-1">Expansion of <Keyword id="influence" color="#2ABB3A">Influence (影响力)</Keyword></span>
      </>,
      content: (
        <>
          <p>
          ...
          <p>
            ...
            <Keyword id="grace" color="#F68CB2">Grace (优雅)</Keyword> (478 times)
            and
            <Keyword id="resilience" color="#F68CB2">Resilience (韧性)</Keyword> (1,309 times)
            . Compared to the Chinese model's focus on "body shape," the English model emphasizes a woman's
            <Keyword id="poise" color="#F68CB2">Poise (风度)</Keyword>
            and
            <Keyword id="confidence" color="#F68CB2">Confidence (自信)</Keyword>.
          </p>
          <p>
            However, male keywords point directly to social power.
            <Keyword id="influence" color="#2ABB3A">Influence (影响力)</Keyword> (1,089 times),
            <Keyword id="individual" color="#2ABB3A">Individual (个体)</Keyword> (847 times),
            and
            <Keyword id="intellectual" color="#2ABB3A">Intellectual (智力特质)</Keyword>
    ...
    {
      titleLeft: <>
        <span className="mx-1">Multiple Burdens of <Keyword id="care" color="#F68CB2">Care (关怀)</Keyword> vs.</span>
        <span className="mx-1">Boundless Participation of <Keyword id="explore" color="#2ABB3A">Explore (探索)</Keyword></span>
      </>,
      content: (
        <>
          <p>
          ...
          <p>
            ...
            <Keyword id="community" color="#F68CB2">Community (社区)</Keyword> (1,474 times),
            <Keyword id="balance" color="#F68CB2">Balance (平衡)</Keyword> (676 times),
            and
            <Keyword id="education" color="#F68CB2">Education (教育)</Keyword> (837 times)
          ...
          <p>
            ...
            <Keyword id="explore" color="#2ABB3A">Explore (探索)</Keyword>,
            <Keyword id="diplomacy" color="#2ABB3A">Diplomacy (外交)</Keyword>,
            and
            <Keyword id="technology" color="#2ABB3A">Technology (科技)</Keyword>
    ...
    {
      titleLeft: <>
        <span className="mx-1">Compensation of <Keyword id="advocacy" color="#F68CB2">Advocacy (抗争)</Keyword> vs.</span>
        <span className="mx-1">Dominance of <Keyword id="strategy" color="#2ABB3A">Strategy (策略)</Keyword></span>
      </>,
      content: (
        <>
          <p>
          ...
          <p>
            ...
            <Keyword id="equality" color="#F68CB2">Equality (平等)</Keyword> (495 times),
            <Keyword id="empowerment" color="#F68CB2">Empowerment (赋权)</Keyword> (321 times),
            and
            <Keyword id="advocate" color="#F68CB2">Advocate (倡议)</Keyword> (319 times)
          ...
          <p>
            ...
            <Keyword id="strategic" color="#2ABB3A">Strategic (策略)</Keyword>,
            <Keyword id="geopolitical" color="#2ABB3A">Geopolitical (地缘政治)</Keyword>,
            and
            <Keyword id="perspective" color="#2ABB3A">Perspective (视野)</Keyword> (160 times)
