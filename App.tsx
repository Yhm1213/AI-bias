    ...
    >
      ...
      <section className="min-h-screen w-full snap-start relative flex flex-col items-center justify-center py-32 px-6">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-24 pt-16">
            ...
            >
              ...
              <div className="absolute -top-12 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 group-hover:-translate-y-2 transition-all duration-300 pointer-events-none z-10">
                <img src="/ICON/cursor_pink.png" alt="cursor" className="w-6 h-auto" />
              </div>

              <div className="w-32 h-32 flex items-center justify-center mb-6 transition-all duration-300">
                <img src="/ICON/buttom01_cn.png" alt="icon" className="w-full h-full object-contain group-hover:hidden transition-all duration-300" />
                <img src="/ICON/buttom01_cn_hover.png" alt="icon hover" className="w-full h-full object-contain hidden group-hover:block transition-all duration-300" />
              </div>
            ...
            >
              ...
              <div className="w-32 h-32 flex items-center justify-center mb-6 transition-all duration-300">
                <img src="/ICON/buttom02_cn.png" alt="icon" className="w-full h-full object-contain group-hover:hidden transition-all duration-300" />
                <img src="/ICON/buttom02_cn_hover.png" alt="icon hover" className="w-full h-full object-contain hidden group-hover:block transition-all duration-300" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full px-6 md:px-12 flex justify-between items-end z-10 mt-32">
          ...
          >
            <img src="/ICON/data_zh.png" alt="Data Explanation" className="w-full h-full object-contain absolute inset-0 transition-opacity duration-300 opacity-100 group-hover:opacity-0" />
            <img src="/ICON/data_zh_hover.png" alt="Data Explanation Hover" className="w-full h-full object-contain absolute inset-0 transition-opacity duration-300 opacity-0 group-hover:opacity-100" />
          </div>
          ...
          >
            <img
              src={language === 'CN' ? "/ICON/language_zh.png" : "/ICON/language_en.png"}
              alt="Language Switch"
